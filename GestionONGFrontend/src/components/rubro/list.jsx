...
const List = () => {
  ...
  return (
    <div className="container mt-5 mb-3">
      <h1 className="text-center mb-4 mt-5">Lista de Rubros</h1>
      ...
      <div className="row">
        {allData.map((rubro) => (
          <div key={rubro.id} className="col-md-4 col-sm-6 mb-3">
            <div className="card">
              <div className="card-body d-flex justify-content-between align-items-center">
                ...
                <div className="dropdown">
                  <button
                    ...
                    type="button"
                    id={`dropdownMenuButton-${rubro.id}`}
                  ...
                  <ul
                    ...
                    aria-labelledby={`dropdownMenuButton-${rubro.id}`}
                  >
                    <li>
                      <button
